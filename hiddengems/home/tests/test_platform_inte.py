...
class BrowserPlayableTests(TestCase):
    ...
    def test_browser_game_detail_page_loads(self):
        ...
        response = self.client.get(
            reverse("game_detail", args=[self.browser_game.slug])
        )
    ...
    def test_upload_game_as_browser_playable(self):
        ...
        self.assertTrue(
            Game.objects.filter(title="My Web Game", playable_in_browser=True).exists()
        )
    ...
    def test_upload_game_as_non_browser_playable(self):
        ...
        self.assertTrue(
            Game.objects.filter(
                title="My Desktop Game", playable_in_browser=False
            ).exists()
        )
