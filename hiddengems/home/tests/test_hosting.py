...
class GameModelSadPathTests(TestCase):
    ...
    def test_duplicate_slug_gets_incremented(self):
        ...
        game1 = Game.objects.create(
            title="Same Title", description="First", price="9.99"
        )
        game2 = Game.objects.create(
            title="Same Title", description="Second", price="9.99"
        )
        game3 = Game.objects.create(
            title="Same Title", description="Third", price="9.99"
        )
    ...
    def test_developer_field_can_be_blank(self):
        ...
        game = Game.objects.create(
            title="No Dev Game", description="desc", price="9.99"
        )
    ...
    def test_publisher_field_can_be_blank(self):
        ...
        game = Game.objects.create(
            title="No Publisher Game", description="desc", price="9.99"
        )
    ...
    def test_other_platforms_can_be_blank(self):
        ...
        game = Game.objects.create(
            title="Solo Platform Game", description="desc", price="9.99"
        )
    ...
    def test_storefront_defaults_to_steam(self):
        ...
        game = Game.objects.create(
            title="Default Store Game", description="desc", price="9.99"
        )
    ...
    def test_uploaded_by_can_be_null(self):
        ...
        game = Game.objects.create(
            title="Orphan Game", description="desc", price="9.99"
        )
    ...
    def test_authorized_users_can_be_empty(self):
        ...
        game = Game.objects.create(
            title="Restricted Game", description="desc", price="9.99"
        )
